...
GoogleParseAuth.prototype.makeAuthenticatedCall = function(/* userId, function, ... arguments ..., callback*/){
	var userId = arguments[0]
	var func = arguments[1]
	var callback = arguments[arguments.length - 1];
	var args = Array.prototype.splice.call(arguments, 2, arguments.length - 3);
	...
	this.retrieveAccessToken(userId, function(err, accessToken) {
		...
		console.log("args now: ", args);
		func.apply(null, args_copy);
	});
