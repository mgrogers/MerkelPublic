...
GoogleCalendarParse.prototype.sendRequest = function(type, url, user_id, option, body, callback, try_refresh) {
    var T = this;
    var access_token = this.retrieveAccessToken(user_id, function() {
